...
title('Plot of Column 1 vs Columns 5 and 9 - Data1'); % Title for the first subplot
...
plot(data2(:,1), data2(:,6), 'r-', 'LineWidth', 1.5); % Line plot for column 6
grid on; % Add a grid
xlabel('Time (s)'); % Label for the x-axis
ylabel('Y-axis Label'); % Replace with your y-axis label
title('Plot of Column 1 vs Column 6 - Data2'); % Title for the second subplot
xlim([time_lower_bound, time_upper_bound]); % Set x-axis limits
